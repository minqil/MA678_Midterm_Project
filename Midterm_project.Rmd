...
```{r, echo=FALSE, fig.align='center', fig.height=3.5, fig.width=5.5,fig.cap= "The plot of density estimate for price in each city."}
...
```{r, echo=FALSE, fig.align='center', fig.height=3.5, fig.width=5.5, fig.cap= "The scatterplot and linear Regression between the number of guests and log(price) for each city."}
...
```{r,echo=FALSE, fig.height=3.5, fig.width=5.5, fig.cap = "The model's fixed effect and their 95% confidence interval."}

# plot of fixed effect
ggplot(coefdisplay[2:8,]) + aes(x=med,y=names) + geom_point() +
...
```{r, echo=FALSE, fig.align='center', fig.height=3, fig.width=5, fig.cap= "Residual plot"}
...
```{r, echo=FALSE,fig.align='center', fig.height=3, fig.width=5, fig.cap= "Density estimates of posterior predicted values and the fitted values."}
set.seed(1)
...
\newpage
# Appendix
## 1. The correlation matrix among variables
...
## plot
corrplot::corrplot(correlation1,method = "color", addCoef.col = "grey", addCoefasPercent=TRUE,tl.col = "black", tl.srt = 45, tl.cex=0.8, number.cex = 0.5)
```
...
corrplot::corrplot(correlation_price,method="color",addCoef.col="grey",addCoefasPercent=TRUE,tl.col = "black", tl.srt = 45,tl.cex=0.8,number.cex = 0.5)
```

\newpage
## 3. The plot of reviews in per month vs Log(price) for each city
